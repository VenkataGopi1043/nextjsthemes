    ...
    <div className="flex flex-col flex-shrink-0 bg-white  shadow-lg p-10">
      ...
      <div className="flex flex-col">
        <ul className="space-y-2">
          ...
          <li>
            <a className="flex items-centre gap-3 px-3 py-2 cursor-pointer hover:text-blue-700 text-gray-300 rounded-lg">
              Calender
            </a>
          </li>
          <li>
          ...
          <li>
            <a className="flex itmes-centre gap-3 px-3 py-2 cursor-pointer hover:text-blue-700 text-gray-300 rounded-lg">
              Contants
            </a>
          </li>
          <li>
